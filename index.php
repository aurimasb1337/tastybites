...
<head>
    ...
    <script
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB572ZPvnGt-qhLSNK-d4eqaP8vOP5iopA&map_ids=23208ddb9891e15e&callback=initMap&libraries=&v=weekly"
        defer></script>
    ...
    function initMap() {
        ...
        var locations = [
      ['Charlie Pizza', 54.683160, 25.219250, 4],
      ['Brooklyn Brothers', 54.613160, 25.219250, 5],
      ['Cili pica', 54.623160, 25.289250, 3],
      ['Dodo pizza', 54.653160, 25.209250, 2],
      ['Niamu Kebabai', 54.693160, 25.209250, 1],
      ['Jurgis ir drakonas', 54.683160, 25.289250, 6]
    ];
  ...
  google.maps.event.addListener(marker, 'click', (function(marker, i) {
    return function() {
      ...
      infowindow.open(map, marker);
        ...
        //        // The marker, positioned at location_1
   ...
   ?>
    ...
    <div class="container-fluid main">
        ...
        <div class="row no-gutters"> 
            ...
            <div id="splitOne" class="col-lg-6 col-sm-12 col-md-6 text-center">
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
       // echo "<br> id: ". $row["id"]. " - Name: ". $row["name"]. " " . $row["location"] . "<br>";
        $imgPath=$row['img'];
        $rest_id=$row['id'];
        $price_range=$row['price_range'];
     
      ?>
	  <a href="order.php?restaurant_id=<?=$rest_id?>">  <div class="item">
        <div class="row">
              ...
              <div  id="itemsplit" class="col-lg-6 col-sm-6 col-md-6 text-center">
              
                    <h3>
                     <?= $row["name"]
?>                    </h3>
                    <p><i class="fas fa-location-arrow"></i> <?=$row["location"] ?>
                    </p>
                  <hr>
...
?>
            ...
            <div id="splitTwo" class="col-6 col-sm-12 col-md-4">
    ...
    <footer id="duk" class="bg-light  text-center text-lg-start">
  <!-- Grid container -->
  <div class="container p-4">
    ...
    <div class="row">
      ...
      <div class="col-lg-6 col-md-12 mb-4 mb-md-0">
        <h3 class="text-uppercase">D.U.K</h3>
  ...
  <div class="card">
    <div class="card-header" id="headingOne">
      <h2 class="mb-0">
        <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
         Ar galima išankstinė registracija?
        </button>
      </h2>
    </div>
    ...
    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
      <div class="card-body">
        Taip, registracija galite atlikti paspaudę ant restorano, išsirinkę maistą ir svečių kiekį.
      </div>
    </div>
  </div>
  <div class="card">
    <div class="card-header" id="headingTwo">
      <h2 class="mb-0">
        <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
         Ar galiu atšaukti rezervacija?
        </button>
      </h2>
    </div>
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
      <div class="card-body">
       Tai galite padaryti tik susisiekę su mumis telefonu arba el. paštu.
      </div>
    </div>
  </div>
  <div class="card">
    <div class="card-header" id="headingThree">
      <h2 class="mb-0">
        <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
         Ar galima atlikti rezervaciją šventėmis?
        </button>
      </h2>
    </div>
    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
      <div class="card-body">
       Taip, jeigu tuo metu sistemoje bus laisvų vietų restorane.
      </div>
    </div>
  </div>
</div>
